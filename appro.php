...
<body>
    ...
    <?php foreach($produits as $prod) : ?>
            <div class="colonne">
                ...
                <form action="post_appro.php" method="POST">
                    <input type="hidden" value="<? echo $prod['idPdr'] ?>" name ="idPdr">
                    <input type="hidden" value="<? echo $idFrns ?>" name ="idFrns">
                 ...
                 <button type="submit" class="btn btn-outline-dark"><i class="fa fa-plus-circle"></i> Achat</button>
                            </div>
                        </div>
                </div>
    <?php endforeach ?>  
